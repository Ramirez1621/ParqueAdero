<?php
    ...
    /*== Verificando nombre ==*/
        ...
        /*== Guardando datos ==*/
        $guardar_parqueadero=conexion();
        $guardar_parqueadero=$guardar_parqueadero->prepare("INSERT INTO parqueaderos(nombre_parqueadero,ubicacion_parqueadero) VALUES(:nombre,:ubicacion)");
        ...
        $guardar_parqueadero->execute($marcadores);
    
        if($guardar_parqueadero->rowCount()==1){
            echo '
