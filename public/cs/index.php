...
<html lang="en">
   <head>
      ...
      <!-- bootstrap css -->
      <link rel="stylesheet" href="<?php echo URL;?>/cs/css/bootstrap.min.css">
      <!-- style css -->
      <link rel="stylesheet" href="<?php echo URL;?>/cs/css/style.css">
      <!-- Responsive-->
      <link rel="stylesheet" href="<?php echo URL;?>/cs/css/responsive.css">
      <!-- fevicon -->
      <link rel="icon" href="<?php echo URL;?>/cs/images/fevicon.png" type="image/gif" />
      <!-- Scrollbar Custom CSS -->
      <link rel="stylesheet" href="<?php echo URL;?>/cs/css/jquery.mCustomScrollbar.min.css">
   ...
   <body class="main-layout">
      <!-- loader  -->
      <div class="loader_bg">
         <div class="loader"><img src="<?php echo URL;?>/cs/images/loading.gif" alt="#" /></div>
      </div>
      <div class="wrapper">
         <!-- end loader -->
         <div class="sidebar">
            ...
            <nav id="sidebar">
               ...
               <ul class="list-unstyled components">
                  <li class="active">
                     <a href="<?php echo URL;?>/cs/index.html">Home</a>
                  </li>
                  <li>
         ...
         <div id="content">
                           ...
                           <div class="col-md-3 logo_section">
                              <div class="full">
                                 <div class="center-desk">
                                    <div class="logo">
                                       <a href="<?php echo URL;?>/cs/index.html"><img src="<?php echo URL;?>/cs/images/logo.png" alt="#"></a>
                                    </div>
                                 </div>
                              </div>
                           </div>
                              ...
                              <div class="right_header_info">
                                 <ul>
                                    ...
                                    <li>
                                       ...
                                       <img src="<?php echo URL;?>/cs/images/menu_icon.png" alt="#" />
                                       </button>
                                    </li>
                                 </ul>
                              </div>
            ...
            <section class="slider_section">
               <div class="banner_main">
                  <img src="<?php echo URL;?>/cs/images/bg_main.jpg" alt="#"/>
            ...
            <div class="container">
               ...
               <div class="row">
                  <div class="col-md-4 padding_bottom">
                     <div class="game_box">
                        <figure><img src="<?php echo URL;?>/cs/images/game1.jpg" alt="#"/></figure>
                     </div>
                     <div class="game">
                        <h3>Game 1</h3>
                     </div>
                  ...
                  <div class="col-md-4 padding_bottom">
                     <div class="game_box">
                        <figure><img src="<?php echo URL;?>/cs/images/game2.jpg" alt="#"/></figure>
                     </div>
                     <div class="game">
                        <h3>Game 2</h3>
                     </div>
                  ...
                  <div class="col-md-4 padding_bottom">
                     <div class="game_box">
                        <figure><img src="<?php echo URL;?>/cs/images/game3.jpg" alt="#"/></figure>
                     </div>
                     <div class="game">
                        <h3>Game 3</h3>
                     </div>
                  ...
                  <div class="col-md-4 margin_bottom1">
                     <div class="game_box">
                        <figure><img src="<?php echo URL;?>/cs/images/game4.jpg" alt="#"/></figure>
                     </div>
                     <div class="game">
                        <h3>Game 4</h3>
                     </div>
                  ...
                  <div class="col-md-4 margin_bottom1">
                     <div class="game_box">
                        <figure><img src="<?php echo URL;?>/cs/images/game5.jpg" alt="#"/></figure>
                     </div>
                     <div class="game">
                        <h3>Game 5</h3>
                     </div>
                  ...
                  <div class="col-md-4">
                     <div class="game_box">
                        <figure><img src="<?php echo URL;?>/cs/images/game6.jpg" alt="#"/></figure>
                     </div>
                     <div class="game">
                        <h3>Game 6</h3>
                     </div>
                                 ...
                                 <div class="carousel-caption ">
                                    <div class="row d_flex">
                                       ...
                                       <div  class="col-md-6">
                                          <div class="test_box">
                                             <div class="jons">
                                                <figure><img src="<?php echo URL;?>/cs/images/jons_img1.png" alt="#"/></figure>
                                             </div>
                                          </div>
                                       </div>
                                    </div>
                        ...
                        <div class="row d_flex">
                           <div class="col-md-4">
                              <div class="many_box_img">
                                 <figure><img src="<?php echo URL;?>/cs/images/imag.jpg" alt="#"/></figure>
                              </div>
                           </div>
                           <div class="col-md-8">
                              <div class="many_box">
                  ...
                  <div class="col-md-10 offset-md-1">
                     <div class="customer_text">
                        ...
                        <div class="customer_box">
                           <i><img src="<?php echo URL;?>/cs/images/customer.png" alt="#"/></i>
                           <h4>Mark jo</h4>
                           ...
                           <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                              <div class="address">
                                 ...
                                 <ul class="Menu_footer">
                                    <li class="active"> <a href="<?php echo URL;?>/cs/index.html">Home</a> </li>
      ...
      <!-- Javascript files-->
      <script src="<?php echo URL;?>/cs/js/jquery.min.js"></script>
      <script src="<?php echo URL;?>/cs/js/popper.min.js"></script>
      <script src="<?php echo URL;?>/cs/js/bootstrap.bundle.min.js"></script>
      <script src="<?php echo URL;?>/cs/js/jquery-3.0.0.min.js"></script>
      <!-- sidebar -->
      <script src="<?php echo URL;?>/cs/js/jquery.mCustomScrollbar.concat.min.js"></script>
      <script src="https:cdnjs.cloudflare.com/ajax/libs/fancybox/2.1.5/jquery.fancybox.min.js"></script>
       <script src="<?php echo URL;?>/cs/js/custom.js"></script>
